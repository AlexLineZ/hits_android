...
class TokenType(val name: Name, val identifier: Identifiers, val regex: Regex, val priority: Int = -1)
...
val tokensList = mutableMapOf<String, TokenType>(
    ...
    "double"   to TokenType(Name.DOUBLE,           Identifiers.LITERAL,          Regex("^(((-?0|-?[1-9]\\d*)|(0))(\\.\\d*))")),
